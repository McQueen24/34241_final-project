...
camLeft.setPreviewSize(640, 400)  # Match mono resolution in example
...
camRight.setPreviewSize(640, 400)  # Match mono resolution in example
...
# Linking
camLeft.preview.link(depth.left)
camRight.preview.link(depth.right)
